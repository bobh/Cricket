...
// Example usage in a SwiftUI project:
// struct ContentView: View {
//     var body: some View {
//         HStack(spacing: 20) {
//             LEDView(color: .green, mode: .on, size: 30)
//             LEDView(color: .green, mode: .off, size: 30)
//             LEDView(color: .green, mode: .blink, size: 30)
//         }
//         .padding()
//         .background(Color.black) // Match dark background for consistency
//     }
// }
