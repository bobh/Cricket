...
The solution combines external Bluetooth Low Energy (BLE) sensors with native iOS/macOS applications to deliver real-time, hyperlocal environmental data directly to users' devices, complete with widget integration, Siri support, and automation capabilities.
...
- **FR-013**: Provide complete Arduino Nano 33 Sense Rev 2 firmware for environmental sensing
...
- **FR-017**: Provide serial debug output for development and troubleshooting
